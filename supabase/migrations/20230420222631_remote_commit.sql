...
ALTER TABLE ONLY "public"."winning_books"
    ADD CONSTRAINT "winning_books_book_id_fkey" FOREIGN KEY ("book_id") REFERENCES "public"."books"("id") ON DELETE CASCADE;
...
CREATE POLICY "Allow update for admin" ON "public"."votes" FOR UPDATE TO "authenticated" USING ((( SELECT "profiles"."role"
   FROM "public"."profiles"
  WHERE ("auth"."uid"() = "profiles"."id")) = 'admin'::"text")) WITH CHECK ((( SELECT "profiles"."role"
   FROM "public"."profiles"
  WHERE ("auth"."uid"() = "profiles"."id")) = 'admin'::"text"));
